export default function leiaFocus(self, destroy) {
  ...
  document.getElementById("divMascara").style.zIndex = "2222";
  document.getElementById("divMascara2").style.zIndex = "2222";
  ...
  window.addEventListener("mousemove", (e) => {
    ...
    // document.getElementById("divMascara").style.transition = "100ms";
    // document.getElementById("divMascara2").style.transition = "50ms";
  ...
  if (destroy) {
    ...
    document.querySelector('._access-menu [data-access-action="leiaFocus"]')
